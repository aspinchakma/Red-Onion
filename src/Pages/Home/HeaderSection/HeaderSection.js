                ...
                <Container fluid>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        >
                            ...
                            <Nav.Link as={Link} className="header-common-button" to="/signIn">Login</Nav.Link>
                            <Nav.Link as={Link} to="/signUp"><button className="sign_up_button">Sign up</button></Nav.Link>
